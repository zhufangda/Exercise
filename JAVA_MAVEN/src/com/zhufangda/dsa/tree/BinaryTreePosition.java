...
public interface BinaryTreePosition<T> extends Position<T> {
     ...
     */
    BinaryTreePosition<T> getParent();
     ...
     * @param parent 父节点
     */
    void setParent(BinaryTreePosition<T> parent);
     ...
     */
    BinaryTreePosition<T> getLeftChild();
     ...
     */
    void setLeftChild(BinaryTreePosition<T> leftChild);
     ...
     */
    BinaryTreePosition<T> getRightChild();
     ...
     */
    void setRightChild(BinaryTreePosition<T> rightChild);
     ...
     * @return 返回当前节点
     */
    BinaryTreePosition<T> attachLeft(BinaryTreePosition<T> c);
     ...
     * @return 返回当前节点
     */
    BinaryTreePosition<T> attachRight(BinaryTreePosition<T> c);

    /**
     * 前序遍历
     * @return 前序遍历的迭代器
     */
    Iterator<BinaryTreePosition<T>> preorderIterator();

    /**
     * 中序遍历
     * @return 前序遍历的迭代器
     */
    Iterator<BinaryTreePosition<T>> inorderIterator();
     ...
     * @return 前序遍历的迭代器
     */
    Iterator<BinaryTreePosition<T>> postorderIterator();

    /**
     * 层次遍历
     * @return  层次遍历的迭代器
     */
    Iterator<BinaryTreePosition<T>> levelorderIterator();
